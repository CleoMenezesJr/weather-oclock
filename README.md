...
A simple extension for GNOME Shell 45+ that adds an icon representing the current weather condition and the current temperature inside the pill next to the clock.
